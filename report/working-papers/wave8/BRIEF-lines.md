# Wave 8: expansion lines (second wave)
...
## Output (write into working-papers/wave8/lines/<line-folder>/)

1. `<line>.md`, the working paper:
   - Title, then "Line: <ID and name> (wave 8). Source prefix: <PFX>. Date: 25 September 2026."
...
Wave 7 ran six lines whose results are in working-papers/wave7/lines/ (L1 public meals, L2 fiscal and tariff rules, L3 funder units and fit, L4 commitments and competitors, L5 T1 unit economics, L6 base rates). Read the verdict and "What this changes" sections of any wave 7 line that touches yours and do not repeat its work; cite its sources by their IDs (PMR, FTR, FUF, CPC, TIC, BRD prefixes). Wave 8 tests whether **different kinds of question** still pay. Be especially strict about calling a result noise when it only adds citations.
