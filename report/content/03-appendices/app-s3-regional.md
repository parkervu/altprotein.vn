---
id: app-s3-regional
title: "S3. Regional comparators and approvals"
short_title: "S3. Regional"
section: appendix
order: 23
...
charts: [chart-hawkwood-scores, chart-regional-approvals, chart-cassava-starch-trade]
---
...
From `countries.csv`. "PF" is precision fermentation. The Hawkwood regulatory score is 100 for novel-food guidance plus an approved fermentation-derived ingredient, 50 for a framework without such an approval, and 0 for no framework or guidance [@RGN-01] {general|High}.
...
## S3.3 Approvals to date

### S3.3.1 Singapore: 18 approvals on the list dated 14 August 2026

Dates are the SFA "date allowed to be used as food" [@RGN-04] {VN-adjacent|High}.

| ID | Date | Company | Product | Category |
|---|---|---|---|---|
| APR-001 | 21 May 2019 | Triton Algae Innovations | *Chlamydomonas reinhardtii* THN6 (green) algae biomass | Microalgae |
| APR-002 | 26 Nov 2020 | Eat Just | Cultured chicken cells | Cultivated |
| APR-003 | 6 Aug 2021 | Nature's Fynd | Mycelial biomass, *Fusarium* strain flavolapis | Biomass |
| APR-004 | 29 Sep 2022 | Solar Foods | Protein powder from *Xanthobacter* sp. SOF1 (Solein) | Biomass (gas fermentation) |
| APR-005 | 19 Oct 2022 | Triton Algae Innovations | *Chlamydomonas reinhardtii* TAI114 (red) algae biomass | Microalgae |
| APR-006 | 11 Jan 2023 | Eat Just | Cultured chicken cells, serum-free media | Cultivated |
| APR-007 | 20 Feb 2023 | Remilk | Animal-free beta-lactoglobulin (*Komagataella phaffii*) | PF |
| APR-008 | 14 Mar 2024 | The Protein Brewery | Fungal biomass, *Rhizomucor pusillus* (Fermotein) | Biomass |
| APR-009 | 22 Mar 2024 | Vow | Cultured Japanese quail fibroblasts | Cultivated |
| APR-010 | 15 Oct 2024 | The Better Meat Co | Mycoprotein, *Neurospora crassa* (Rhiza) | Biomass |
| APR-011 | 13 Mar 2025 | Amazentis | Urolithin A | Chemical synthesis |
| APR-012 | 18 Jun 2025 | Chr. Hansen | 3'-sialyllactose sodium salt (GM *E. coli*) | PF |
| APR-013 | 18 Jun 2025 | Chr. Hansen | 6'-sialyllactose sodium salt (GM *E. coli*) | PF |
| APR-014 | 24 Sep 2025 | Infinite Roots | Mycelium biomass, *Pleurotus pulmonarius* | Biomass |
| APR-015 | 17 Oct 2025 | Vital Meat (Parima group) | Cultivated chicken biomass (embryonic stem cells) | Cultivated |
| APR-016 | 10 Apr 2026 | Supreme SAS (Parima group) | Cultured duck (embryonic stem cells) | Cultivated |
| APR-017 | 27 Apr 2026 | Ultimeat | Mycoprotein, *Neurospora crassa* (Noushroom) | Biomass |
| APR-018 | 22 Jul 2026 | Aleph Farms | Cultivated thin-cut steak (bovine cells in a plant-protein base) | Cultivated |

By category: 6 cultivated, 6 fungal or bacterial biomass, 3 precision-fermented, 2 microalgae and 1 synthetic compound [@RGN-04] {VN-adjacent|High}.
...
|---|---|---|---|
| Singapore | Singapore Food Story (2019). In November 2025, Singapore Food Story 2 dropped the "30 by 30" goal; the new 2035 local production targets (20% of fibre, 30% of protein, meaning eggs and seafood) exclude alternative protein "given the nascency of the sector" | S$144 million R&D programme (from 2019); S$165 million "Food Story 2.0" research programme (per GFI); S$42 million to 11 future food projects (2025) | [@RGN-08; @RGN-09; @RGN-19; @RGN-22] {VN-adjacent\|Medium} |
...
### S3.7.1 Imports of food-protein ingredients are small

From `trade_flows.csv`. Vietnam-reported tonnages are WITS estimates (every partner shows the same unit value), so we quote values and use China's mirror data for tonnage [@RGN-45; @RGN-46] {VN-direct|Medium}.

| ID | Flow | Product (HS) | Year | Volume | Value | Main partners | Evidence |
|---|---|---|---|---|---|---|---|
| TF-001 | Import (Vietnam-reported) | Peptones and other protein substances, including soy protein isolate (3504) | 2023 | 2,421 t (WITS estimate) | USD 22.2 million | China 45% (USD 10.1 million); US USD 3.4 million; Spain USD 2.6 million; Japan USD 1.7 million; Singapore USD 1.3 million | [@RGN-45] {VN-direct\|Medium} |
| TF-002 | Import (Vietnam-reported) | Protein concentrates and textured protein substances (2106.10) | 2023 | 5,763 t (WITS estimate) | USD 34.0 million | US 46% (USD 15.6 million); China 27% (USD 9.1 million); "Other Asia" (probably Taiwan) USD 5.6 million; India USD 1.6 million | [@RGN-46] {VN-direct\|Medium} |
| TF-003 | Import (China mirror) | 3504 from China | 2023 | 10,028 t | USD 16.3 million | China | [@RGN-48] {VN-direct\|Medium} |
...
- **Assumptions** [@RGN-01] {general|High}:
  ...
  - Talent: engineering, manufacturing and construction graduates, vocational enrolment, and R&D researchers per million people.
  - Business environment: the World Bank Ease of Doing Business index (2021 data vintage per the table header), which was discontinued in 2021.
  - Regulatory readiness: as in section S3.2.
- **Scores** are min-max within the nine countries, from 0 to 100, with 100 best [@RGN-01] {general|High}.

### S3.8.2 Vietnam's inputs and scores

| Dimension | Vietnam input | Vietnam index (0 to 100) | Best in region |
|---|---|---|---|
| Sugar capability | 2024 production 1,350 kt; exports 0; imports 110 kt | 26 | Thailand 100 |
| Construction cost | USD 1,672/m2 | 93 | Indonesia 100 |
| Utilities | USD 0.08/kWh; water USD 0.31 per 15 m3 a month | 97 | Indonesia 99 (highest printed) |
| Labour | USD 342/month manufacturing wage | 100 | Vietnam and Indonesia (USD 350) 100 |
| Talent | Engineering, manufacturing and construction graduates 20%; vocational 25%; 779 researchers per million | 26 | Korea 68 |
| Business environment | World Bank Ease of Doing Business about 70 | 30 | Singapore 100 |
| Regulatory readiness | No framework, no approvals | 0 | Singapore and Australia 100 |

Source for the whole table: [@RGN-01] {VN-direct|High}. The study also claims Vietnam had "the region's highest sugar yield per hectare" in 2024; we did not verify this (DG-082).
...
|---|---|---|---|---|---|---|---|---|
| Vietnam | 26 | 93 | 97 | 100 | 26 | 30 | 0 | Wage USD 342/month |
| Thailand | 100 | 81 | 84 | 99 | 36 | 74 | 50 | Sugar production 10,040 kt, exports 5,300 kt; wage USD 431/month |
| Indonesia | 14 | 100 | 99 | 100 | 18 | 29 | 0 | Construction USD 1,487/m2; USD 0.07/kWh; wage USD 350; sugar imports 5,000 kt |
| Philippines | 31 | 94 | 75 | 97 | 17 | 0 | 0 | |
| Malaysia | 0 | 38 | 87 | 93 | 29 | 80 | 0 | See S3.2 on the regulation score |
| Australia | 60 | 0 | 13 | 0 | 50 | 79 | 100 | |
| South Korea | 0 | 22 | 80 | 29 | 68 | 91 | 50 | |
...
- Vietnam "presents one of the region's most cost-competitive environments" and "a potential first-mover opportunity" [@RGN-01] {VN-direct|High}.
- Obstacles: "constraints in feedstock supply, the absence of a clear regulatory pathway for novel foods, and limited experience with industrial-scale fermentation" [@RGN-01] {VN-direct|High}.
- Its three recommendations for Vietnam: "Operationalise Resolution 36 via funded programs with specific agency mandates"; "Clarify incentive eligibility criteria, timelines, and application processes for biomanufacturing sites"; "Publish regulatory procedures and statutory timelines for novel food approvals" [@RGN-01] {VN-direct|High}.
- It cites an unnamed "significant investment in a large-scale biomanufacturing facility" in Vietnam, with no reference [@RGN-01] {VN-direct|Low}.
- A GFI APAC article summarises the study as citing Vietnam's incentives and bioeconomy strategy but also its feedstock limits and regulatory immaturity [@RD-09] {general|Medium}.
...
## S3.9 Lessons from Singapore, Thailand and Korea
...
Sources for the table: [@RGN-04; @RGN-19; @RGN-32; @RGN-34; @RGN-44; @RGN-18] {VN-adjacent|Medium}.
...
| 9 | Hawkwood's unnamed Vietnamese biomanufacturing facility and its sugar data sources | Email the authors |
| 10 | Can a product made in Vietnam be sold in Singapore under an SFA approval? | SFA import and overseas-establishment rules for novel foods |
| 11 | Singapore fees and statutory timelines under the FSSA | Read the FSSA (Authorisations: Administration) Regulations 2025 |
| 12 | Do Chinese mycoprotein and yeast-protein plants use cassava starch? | GFI APAC China team; Guangzhou Shuangqiao disclosures |
| 13 | Could Vietnam join or observe the regional work on cultivated-meat safety, or an ASEAN reliance mechanism? | GFI APAC; the ASEAN Secretariat food safety unit |

## Related data files

- `countries.csv`: 11 country rows behind section S3.2 and S3.4.
- `approvals.csv`: the 33 approval rows in section S3.3.
- `facilities_regional.csv`: the 16 facility rows in section S3.5.
- `trade_flows.csv`: the 12 trade-flow rows in section S3.7.
- `disagreements.csv`: DG-071 to DG-082 cover the regional conflicts cited here (see [[app-r2-disagreements]]).
- Working paper: `working-papers/wave1/regional/regional.md`.
