---
id: app-w-balance-model
title: "W. The protein and feed balance model"
short_title: "W. Balance model"
section: appendix
order: 23
summary: "The documentation behind chapter 17: what the protein and feed balance model covers, the published projections and targets it uses, its steps and parameters, the four scenarios, full results by scenario and year, the sensitivity test, sanity checks, a reality check against other countries, and how to rerun and extend it. Every value for 2030 to 2050 is our estimate from stated assumptions, not a forecast."
...
related_pages: [ch17-protein-balance-2050, ch13-outlook, ch14-unknowns, ch16-frontier-technology, ch18-scenarios-2050, ch19-vision-2050, ch20-robust-moves, app-h-feed-market, app-o-outlook, app-q-open-questions, app-r-disagreements, app-u-futures-method, app-v-frontier-tech, app-z-aquafeed-feedstock-futures]
charts: [chart-sbm-scenarios-2050, chart-sbm-tornado]
---

# W. The protein and feed balance model

**What this appendix contains.** The documentation of the model behind [[ch17-protein-balance-2050]]: purpose and boundary, the published projections and targets it uses, each calculation step with its parameters, the four scenarios, results by scenario and year, the sensitivity test, sanity checks, a reality check against other countries, and how to rerun and extend it.
...
| Calibrated to 2025 totals: 22 Mt of livestock and poultry feed, 6.5 Mt of aquafeed, 7.2 Mt of SBM fed, 11.91 Mt of maize imported | A price or trade model: it cannot say whether microbial protein will compete ([[ch09-economics]], [[ch16-frontier-technology]]) |
...
The model scenarios (S-BASE, S-HIGH, S-EFF, S-ALT) are distinct from the 2035 scenarios of [[ch13-outlook]] and the 2050 worlds of [[ch18-scenarios-2050]], which map onto these ranges without new model runs.
...
**Appendix Z paths.** AQ-BASE in [[app-z-aquafeed-feedstock-futures]] reuses the S-BASE index but lets marine finfish grow faster, reaching 8.86 Mt in 2050 against 8.52 Mt here (aquafeed 9.7 against 9.2 Mt). AQ-LOW (7.42 Mt) matches the low aquaculture sensitivity; AQ-HIGH (11.27 Mt) lies above S-HIGH (8.97 Mt). Because aquaculture growth after 2035 moves 2050 SBM need by only about 1 Mt (W.6), the national result is unchanged {VN-direct|Low} {fx:estimate}.
...
- **S-ALT shares are what-if levels, not targets.** The 40% fishmeal share by 2050 sits within trials that replaced 25 to 60% of fishmeal without growth loss ([[app-h-feed-market]], H9) [@FM-08; @FM-22] {general|Medium}. The 10% SBM share by 2050 implies large cost falls or policy support: at 2026 costs microbial feed protein costs 4.6 to 5.1 times SBM protein ([[ch09-economics]]) [@COST-43] {VN-direct|Low} {fx:estimate}.
...
**Readings.**
- **Formulation and efficiency dominate.** Each 1% a year fall in national SBM inclusion is worth about 2.3 Mt of imports in 2050 (10.40 minus 8.09) {VN-direct|Low} {fx:estimate}. Yet we found no Vietnamese series of SBM inclusion or FCR by species {VN-direct|High}; measuring them is the first job of a protein statistic ([[ch20-robust-moves]]).
...
| 2025 aquafeed | 6.5 Mt | USDA 6.5; industry 3.9 to 4.8 Mt | Calibrated to USDA; industry value tested (W.6) | [@MAC-01; @MAC-06] {VN-direct\|Medium} |
...
| 2025 fishmeal | 262 kt | Edition 1.0 pool 120 to 245 kt, bounds 79 to 290 kt ([[app-h-feed-market]]); OECD-FAO 221 kt | Inside the bounds; ours adds snakehead, marine fish and livestock uses | [@QNT-01] {VN-direct\|Low} |
...
| 2027 SBM supply | 7.7 Mt demand | USDA: 6.85 Mt of meal plus 3.5 Mt of beans imported (MY2026/27) | About 9 Mt or more of supply against USDA's own 7.8 Mt of use; logged (W.9.4) | [@QNT-07] {VN-direct\|Medium} {fx:projection} |
| 2027 maize imports (interpolated) | 12.3 Mt | USDA Post 15 Mt (MY2026/27) | 18% below; not reconciled (W.9.4) | [@MAC-01] {VN-direct\|Medium} {fx:projection} |
| 2030 industrial feed | 33.5 Mt total; 26.4 Mt livestock | Target 30 to 32 Mt, livestock only (W.7.2) | Out of reach on S-BASE | [@NTS-23; @REG-54] {VN-direct\|Medium} {fx:projection} |
...
| 2035 maize feed use; imports | 16.3; 13.9 Mt | OECD-FAO 16.8; 16.6 Mt | 2.6% below; 17% below (non-feed use and output, W.9.4) | [@QNT-01] {VN-direct\|Medium} {fx:projection} |
...
> **Correction.** Edition 1.0 left open whether the 2030 target of 30 to 32 Mt of industrial feed includes aquafeed (OQ-127, [[ch14-unknowns]], [[app-q-open-questions]]), and [[app-o-outlook]] (O.3) noted that on an all-feed reading the target was already close. The feed-industry scheme, Decision 1625/QD-TTg of 15 December 2023, which edition 1.0 did not cite, sets 24 to 25 Mt of industrial livestock feed for 2025 and 30 to 32 Mt for 2030. It refers to *thức ăn chăn nuôi* (livestock feed), so the 2030 target appears to cover livestock and poultry feed only [@NTS-23] {VN-direct|Medium}. This supersedes the all-feed reading and our first model notes, which judged the 2030 value plausible "if the target includes aquafeed". Confidence is Medium: one reading of the text, not confirmed by MAE.
...
| Growth needed, 2025 to 2030 | 6.4 to 7.8% a year, about twice the 2024 and 2025 pace | Our calculation ([[app-o-outlook]]) {VN-direct\|Medium} |
...
| New OECD-FAO edition | Fetch with the W.2.1 recipe; recompute the 2030 and 2035 index rows and the dressing-yield and SSR rows |
...
- No prices, so no statement on competitiveness ([[app-v-frontier-tech]]).
- No climate impacts on Vietnamese farming or on exporters' yields ([[ch15-drivers-2050]]).
...
We give both values and the position taken; these belong in [[app-r-disagreements]].
...
| Gas-route electricity | 25 kWh per kg of biomass (lower case) and 9.86 (laboratory) [@QNT-10]; about 69 MWh per t of protein for a 2030 design [@FTG-01], used in [[ch16-frontier-technology]] {general\|Medium} | 41 kWh per kg of protein | Kept 41. With FTG-01's factor, S-ALT would need about 19 TWh in 2050 (under 2% of planned supply) and the CO2 break-even against SBM would be about 12 g per kWh, not 21 (our calculation). Not yet reconciled |
...
| Gas-route energy factor (41 against 69 kWh per kg of protein) | Consistency of Part V energy and carbon numbers | Reconcile with `frontier_gas_tech.csv` |
| Combined S-EFF plus S-ALT run | No value below S-EFF in the credible range | One new scenario tag (W.9.2) |
...
**Related:** [[ch17-protein-balance-2050]], [[ch19-vision-2050]], [[ch18-scenarios-2050]], [[ch20-robust-moves]], [[app-z-aquafeed-feedstock-futures]], [[app-h-feed-market]], [[app-o-outlook]], [[app-u-futures-method]].
