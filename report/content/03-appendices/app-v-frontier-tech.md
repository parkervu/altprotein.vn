...
related_pages: [ch16-frontier-technology, ch09-economics, ch10-technology-fit, ch17-protein-balance-2050, ch18-scenarios-2050, ch20-robust-moves, app-i-costs, app-j-science, app-k-research, app-m-capital, app-n-regional, app-g-regulation, app-u-futures-method, app-x-drivers-signals, app-z-aquafeed-feedstock-futures, app-q-open-questions, app-r-disagreements]
charts: [chart-frontier-windows, chart-cost-paths-2050]
---

# V. Frontier technology: evidence, costs and windows

**What this appendix contains.** The detail behind [[ch16-frontier-technology]]: an evidence card for each of eleven frontier routes (V.1); the arithmetic for protein made from renewable power in Vietnam (V.2); learning rates and cost paths (V.3); carbon prices and carbon cost per tonne of protein (V.4); AI and bio-design (V.5); approvals and capital (V.6); the research pipeline (V.7); and the windows table (V.8).

**How to use it.** Read a route's card before pricing a deal or programme in it. Test any cost claim against V.2 and V.3. Use V.8 for the condition that opens each window, and [[app-x-drivers-signals]] for the signposts.

> **Method note.** Global cost paths are published models. Vietnamese costs are our calculations from three rerunnable scripts in `working-papers/wave3/`: `frontier_gas/ftg_estimates.py`, `econ_policy/ecf_calc.py` and `next_gen_feedstocks/ngf_calc.py`. The prices to beat are fishmeal protein at USD 2,625 (2025 average) to 3,846 (August 2026) per t and soybean-meal protein at about USD 880 per t [@FM-01] {general|High}. Every window is an estimate with conditions, not a forecast. Tags: [[app-u-futures-method]].
...
| Conditions | The five conditions in V.2.6 |
...
| Cost evidence | Vietnamese fungal feed protein USD 4,050 to 14,700 per t of protein at 2026 prices ([[ch09-economics]]); floor and cost paths in V.3.2. A plant costing USD 100 million in the US costs about USD 15 million in China [@HSC-13] {VN-adjacent\|Medium} |
...
| Item | Evidence |
|---|---|
| Status 2026 | High-value proteins TRL 8 to 9; dairy and egg proteins TRL 7 to 8. Four or more US "no questions" letters in 2025, one for a Chinese firm; approvals in V.6.1 [@FTB-17; @FTB-18; @FTB-19] {general\|Medium} |
| Largest plant | Not disclosed in our sources |
| Cost evidence | Targets only, no model outputs (V.3.4); economic now for high-value proteins such as lactoferrin (USD 750 to 1,500 per kg) [@FTB-23; @FTB-41] {general\|Medium} |
...
| Conditions | A first closed-production GMO certificate; clearance by reliance on US or Singapore decisions; regional food-grade contract capacity above 10 m3; patent expiries (V.6.3) {VN-direct\|Low} |
...
| Cost evidence | 1.6 to 30 times fewer experiments; no lower production cost at scale shown (V.5.1) {general\|High} |
| Failures and limits | Adoption "far below the ceiling"; open data is "the binding constraint" [@FTB-01] {general\|High} |
| Vietnam base | Top-40 AI compute; no biofoundry (V.5.2) {VN-direct\|Medium} |
...
Scale (our calculation, `ngf_calc.py`): the 2050 S-ALT sugar need of 1.32 Mt of glucose would take 3.0 to 4.3 Mt of straw (6 to 10% of national straw) and USD 2.8 to 4.5 billion of first-generation plants, 15 to 21 of Panipat's size {VN-direct|Low} {fx:estimate}. Feedstock cases: [[app-z-aquafeed-feedstock-futures]].
...
| Vietnam base and window | Buyer only; 2026 to 2035 {VN-direct\|Low} {fx:estimate}. Detail in [[app-z-aquafeed-feedstock-futures]] |

---

## V.2 Power-to-protein in Vietnam: the arithmetic

Script: `ftg_estimates.py`. Results in V.2.2 to V.2.6 are our calculations {VN-direct|Low} {fx:estimate}.
...
Script: `ecf_calc.py`, part A. Learning applies only to capital charge and maintenance in edition 1.0's cost stack A (10,000 t a year; [[ch09-economics]]); glucose, urea, power, labour and land stay at 2026 real prices.
...
| Titre | Best published leghemoglobin 10.1 g/L against an "above 50 g/L" benchmark ([[app-j-science]]) | {general\|Medium} |
...
Novel-protein approvals counted from edition 1.0's register (Singapore, US, Israel, Australia and New Zealand, China; 2026 to 14 August) [@RGN-03; @RGN-04] {general|High}:
...
Cheap second-hand tanks cut capital more than any learning curve before 2030, until the cycle turns {general|Medium} {fx:signal}. Clear customs and tax rules for used fermenters would let a Vietnamese feed venture use this in 2027 to 2030 ([[ch20-robust-moves]], RM-15) {VN-direct|Low} {fx:estimate}.
...
| FW-10 | Bulk feed protein from renewable power | 2040 to 2050 (not before about 2040 to 2045) | The five conditions in V.2.6 | none | [@FTG-01; @FTG-03] {VN-direct\|Low} {fx:estimate} |
...
- **The late windows depend on inputs Vietnam can prepare now**: residue carbon, clean power at named sites, cheap capital and process skills ([[ch20-robust-moves]]).

---

## V.9 Gaps and open questions

For [[app-q-open-questions]]; source conflicts are in [[app-r-disagreements]].
...
| 7 | Observed first-plant capex for microbial protein, and a global capacity baseline to anchor the doublings in V.3.2 | Solar Foods, Unibio and Chinese exchange filings; GFI capacity data |
...
**Related:** [[ch16-frontier-technology]], [[ch09-economics]], [[ch10-technology-fit]], [[ch17-protein-balance-2050]], [[ch20-robust-moves]], [[app-i-costs]], [[app-j-science]], [[app-k-research]], [[app-m-capital]], [[app-z-aquafeed-feedstock-futures]], [[app-x-drivers-signals]], [[app-u-futures-method]]
