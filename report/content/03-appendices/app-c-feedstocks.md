...
- **Provinces.** We use the current (post-1 July 2025) province name first and give the former unit in brackets, for example Tay Ninh (former Long An). See [[app-p-admin-map]].
...
- **Tags.** `{VN-direct|High}` and similar tags follow the evidence rules in [[app-a-method]].
...
- **Sites and companies.** Roots are bought by starch factories (see C2), chip traders, the three operating fuel-ethanol plants (see C32) and the MSG makers Vedan, Ajinomoto and Daesang ([[app-f-facilities]]).
...
- **Chips.** Chip exports were 955,670 t in 11 months of 2025 [@FS-01] or 967,460 t in 10 months [@FS-13] {VN-direct|Medium}. Both cannot be chips only. We use the first figure for chips and log the conflict in [[app-r-disagreements]].
...
- **What it could become.** Starch and glucose syrup are the most ready-to-use fermentation carbon in Vietnam, and they are already made at scale next to the aerobic fermenters of Vedan and Daesang. Starch is also the binder in most *đồ chay* (traditional vegetarian food) analogues ([[app-d-retail-audit]]).
...
- **What it could become.** Energy, not protein. It is the cheapest steam fuel for a fermentation plant: about 420 to 585 VND of fuel per kg of steam (see [[app-i-costs]]).
...
- **Locations.** Brewery sites in Ho Chi Minh City (including former Ba Ria-Vung Tau), Hanoi, Hue, Da Nang, Dong Thap (former Tien Giang), Can Tho (former Hau Giang) and the north ([[app-f-facilities]]).
...
- **Rules.** *Saccharomyces cerevisiae* is on the aquafeed list as a microorganism, but "yeast protein" is not a listed raw material [@REG2-01] {VN-direct|High}. See [[app-g-regulation]].
...
- **Sites and companies.** The largest crusher is VAL (Bunge and Wilmar) at Phu My 1 Industrial Park, Ho Chi Minh City (former Ba Ria-Vung Tau): 2.6 Mt of soybeans a year and nearly 2 Mt of meal after a USD 100 M second line (December 2025) [@VCO-16] {VN-direct|Medium}. See [[app-f-facilities]].
...
- **What it could become.** Soy is already the base of tofu, soymilk and imported textured soy protein. We found no soy protein isolate or concentrate plant in Vietnam ([[app-f-facilities]]).
...
- **Sites and companies.** Pangasius and shrimp processors such as Vinh Hoan; see [[app-e-directory]].
- **Current use and buyers.** Fishmeal, fish oil, pangasius collagen and gelatin, shrimp-head meal and chitin. These uses come from earlier leads and were not re-verified. Vietnam exported USD 430.5 M of fishmeal in 2023, 93.5% of it to China, and imported USD 260 M [@FM-37; @FM-38] {VN-direct|Medium}, so much of the by-product meal leaves the country ([[app-h-feed-market]]).
- **Prices.** Not found.
...
- **What it could become.** A domestic single-cell protein side stream, if the incumbents separate and dry their bacterial biomass; see [[app-h-feed-market]] for the prices it would face.
...
- **The feed-ingredient balance.** USDA's 2025 feed-ingredient table shows 23.57 Mt imported out of 28.62 Mt, about 82%. Domestic supply was 5.05 Mt: rice bran and broken rice 2.8 Mt, corn 1.7 Mt and cassava 0.55 Mt. Imports included 9.2 Mt of corn, 7.2 Mt of soybean meal (counting local crush of imported beans), 1.55 Mt of DDGS and 2.58 Mt of feed wheat [@FS-23] {VN-direct|High}. See [[app-h-feed-market]].
...
See [[app-q-open-questions]] for the full register and [[app-r-disagreements]] for the conflicting figures (starch factory count, pulp ratios, chip exports, spent-grain price).
