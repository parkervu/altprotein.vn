---
id: app-k-research
title: "K. Research landscape and bibliometrics"
short_title: "K. Research landscape"
section: appendix
order: 11
...
related_pages: [ch06-knowledge-talent, app-j-science, app-l-labs-talent, app-m-capital, app-e-directory, app-a-method, app-r-disagreements, brief-research]
charts: [chart-research-benchmark]
---

# K. Research landscape and bibliometrics
...
`publications.csv` (103 rows) merges the wave 1 list with 40 top-cited wave 2 records, deduplicated on DOI. The technology science itself (titres, costs, safety) is in [[app-j-science]]; pilot plants, laboratories and graduates are in [[app-l-labs-talent]].
...
5. **Plant-based meat research is about 5 on-topic papers from 2015 to 2026, and no Vietnamese extrusion study** (edition 1.1: the one candidate is Taiwanese; see the correction below) [@BIB-01; @HSC-01] {VN-direct|Medium}.
...
## K.6 Vietnam's adjacent strengths
...
| 10.1093/ijfood/vvae080 | 2025 | Meat-analogue extrudates | Taiwan (verified in edition 1.1) | The only VN-tagged extrusion experiment; all three authors at National Pingtung University of Science and Technology, so not Vietnamese | 9 | [@BIB-01; @HSC-01] {VN-direct\|Medium} |
...
## K.8 Institutions and their capabilities
...
| Ho Chi Minh City Biotechnology Center | Ho Chi Minh City | Claimed pilot fermentation services (not verified; see [[app-l-labs-talent]]) | Low | [@RD-01] {VN-direct\|Low} |
...
## K.9 International collaborations
...
## K.10 Research funding programmes

From `research_funding.csv` (16 rows). Capital-side programmes (venture funds, NATIF loans, philanthropic RFPs for companies) are in [[app-m-capital]].
...
## K.11 Eleven research gaps Vietnam is well placed to fill
...
10. **A DIAAS or PDCAAS reference dataset for Vietnamese protein ingredients** (rice distillers' grain, mung bean, gac seed, spent yeast, catfish side-stream isolates, spirulina). Nothing found [@RD-01] {VN-direct|Medium}. This is a cheap public good every plant-based and feed play needs; no commercial Vietnamese laboratory offering digestibility assays was found either ([[app-l-labs-talent]]).
...
## K.12 Retraction and data-quality flags
...
| Affiliation of the most-cited network papers (the extrusion study was resolved in edition 1.1) | Read the paper headers or OpenAlex institution IDs. |
...
- `science_facts.csv`: technology-level facts used in the corrections above ([[app-j-science]]).
