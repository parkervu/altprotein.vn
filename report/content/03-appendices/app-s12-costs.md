...
related_data: [cost_inputs.csv, commodity_prices.csv, tea_benchmarks.csv, feed_benchmarks.csv, tariffs.csv, protein_tariffs_preferential.csv, t1_cost_per_kg.csv, t1_equipment_listings.csv, t1_landed_competitor.csv, t1_margin_payback.csv, outlook.csv, retail_audit_summary_price_per_protein_by_type.csv, countries.csv, disagreements.csv, open_questions.csv]
related_pages: [ch09-economics, ch03-regional, ch10-technology-fit, ch27-policy-options, app-s4-feedstocks, app-s2-retail-audit, app-s5-facilities, app-s9-regulation, app-s6-feed-market, app-s13-science, app-s3-regional, app-r1-open-questions, app-r2-disagreements]
charts: [chart-cost-stack-fungal, chart-capex-per-tonne]
---

# S12. Cost inputs and techno-economic benchmarks

This appendix holds the numbers behind [[ch09-economics]]. Part one lists Vietnamese input costs in 2026: electricity, water, heat, labour, land, taxes and logistics. Part two gives commodity prices, the protein ingredients Vietnam imports and the retail prices of the proteins an alternative would replace. Part three sets out published techno-economic analyses (TEAs) that we checked against the papers, the spread in capital cost per m3, and what drives cost. Part four gives our tropical cooling estimate and two indicative Vietnamese cost stacks, with the basis of every line. The feed prices a product must beat are in [[app-s6-feed-market]]; raw-material prices are in [[app-s4-feedstocks]].
...
- **Other VAT rates.** The standard rate is 10%. The 5% rate covers clean water, fertiliser and unprocessed farm products at the commercial stage (Art 9(2)) [@COST-24] {VN-direct|High}. A temporary cut from 10% to 8% for many goods has applied since 1 July 2025 (Resolution 204/2025/QH15; Decree 174/2025/ND-CP), and it ends on 31 December 2026 [@COST-25; @FTR-37] {VN-direct|High}. Goods subject to excise are excluded from the cut; from 1 January 2026 that includes sugary drinks above 5 g of sugar per 100 ml (MOF Letter 17380/BTC-CST) [@FTR-09] {VN-direct|High}. Fresh meat, fish and eggs are not subject to VAT at the producer and import stage and pay 5% at the trading stage; processed foods, plant-based or not, including tofu, chay foods, plant-based meat, processed meat and protein ingredients, pay 10% (8% to the end of 2026) [@COST-24; @FTR-37] {VN-direct|High}. So a processed protein product carries a 3 to 5 point VAT handicap against fresh meat at the trading stage, and we found no VAT, excise or income-tax line that favours plant-based or high-protein foods (our reading). Import VAT on food ingredients is creditable for a VAT-registered buyer, so it does not change the comparison between domestic and imported ingredients.
...
- **Import duty on machinery.** Imported fixed-asset goods of projects in incentivised sectors or areas are exempt (Decree 134/2016/ND-CP Art 14, as amended by Decree 18/2021/ND-CP). We did not read the texts; see [[app-s9-regulation]].
- **Import duty on protein inputs** (MFN, and preferential rates for China, ASEAN and Korea, 2025 to 2027) [@REG2-20; @REG2-21; @REG2-23; @FTR-32; @FTR-33] {VN-direct|Medium}:

| HS code | Product | MFN rate (latest found) | ACFTA, ATIGA, AKFTA and RCEP |
|---|---|---|---|
| 1201.90 | Soybeans | 0% | not checked (MFN is 0%) |
| 2304.00.29, 2304.00.90 | Soybean meal | 0% (from 31 March 2025) | 0% |
| 2304.00.21 | Defatted soy flour for human food | 2% (VNTR shows 0%) | 0% |
| 1208.10 | Full-fat soy flour and meal | 8% | 0% |
| 1005.90.99 | Feed maize | 0% (from 31 March 2025; was 2%) | not checked (MFN is 0%) |
| 2301.20 | Fishmeal | 0% | not checked (MFN is 0%) |
| 1109 | Wheat gluten | 10% | 0% |
| 2106.10 | Protein concentrates and textured protein | 5% | 0% |
| 3504 | Peptones and other protein substances | 3% | 0% |
| 2102.10 | Active yeast | 10% | 0% (AKFTA not checked) |
| 2102.20 | Inactive yeast and other dead single-cell organisms | 7% | 0% (AKFTA not checked) |

Feed protein enters duty-free, so domestic novel feed proteins get no tariff shelter. **Food protein ingredients carry small MFN duties, but only on origins without a trade agreement, chiefly the United States.** Chinese, ASEAN and Korean product pays 0% with a certificate of origin, so a domestic textured-protein, gluten or single-cell-protein maker has no tariff edge over Chinese product [@FTR-32; @FTR-33] {VN-direct|Medium}. A maker buying full-fat soy flour from the United States would pay 8% while Chinese textured protein enters free. The MFN column of MOIT's trade repository is out of date for lines amended in 2025, so MFN rates were taken only for lines no amending decree touched [@FTR-32] {VN-direct|Medium}. Whether importers actually claim the preference is not known.
...
- **Cassava, rice by-products and sugar.** Vietnamese prices are in [[app-s4-feedstocks]]: fresh cassava roots 3,000 to 3,550 VND/kg (April 2026), native starch 12,500 to 13,200 VND/kg and USD 520 to 540/t FOB, domestic refined sugar about 16,505 VND/kg (June 2026), rice bran 7,300 to 7,650 VND/kg (September 2026) [@FS-11; @FS-12; @FS-31; @FS-26] {VN-direct|Medium}.
...
### S12.9 Protein ingredients Vietnam imports
...
### S12.10 Retail prices of the proteins an alternative would replace, per 100 g of protein
...
- **Retail audit medians** (VND per 100 g of protein, September 2026): tofu 66,265 (5 SKUs; range 39,171 to 121,053); dried TVP and soy chunks 64,584 (4 SKUs; range 48,976 to 85,053); frozen meat and seafood analogues 278,667 (9 SKUs); protein powders 359,537 (4 SKUs); plant milks 456,250 (8 SKUs) [@FORM-01] {VN-direct|Medium}. See [[app-s2-retail-audit]].
...
### S12.11 Verified TEA benchmarks
...
| Plant-based meat by freeze alignment (Thai-authored; modelled with Japanese wages) | Meat analogue | 100 t/yr | Total capital; minimum selling price | USD 1.76 to 2.48 M; USD 1.18 per 100 g; raw material 32% and labour 24% of cost; not comparable with extrusion | 2023 | No (publisher page summary) | [@COST-56] | {general\|Low} |
| Dry textured vegetable protein, Chinese lines (marketplace listings) | Dry TVP (food) | 200 to 1,500 kg/h | Listed price per complete line with dryer | USD 11,000 to 100,000 a set (list prices, not quotes); installed in Vietnam about USD 0.28 to 1.38 M (our calculation, S12.16) | 2026 | Listings | [@TIC-01; @TIC-02; @TIC-03; @TIC-07] | {general\|Low} |
...
| High-moisture extrusion, Chinese lines (marketplace listings) | Wet meat analogue | 10 to 600 kg/h | Listed price per line | USD 88,000 to 90,000 a set (list price) | 2026 | Listing | [@TIC-09; @TIC-23] | {general\|Low} |
| Plant protein isolate | Isolates | n/a | Capex and opex | No verified benchmark found | n/a | n/a | none | {general\|Low} |
...
### S12.12 Capital cost per m3 and per annual tonne
...
### S12.13 Where the cost is: why cheap labour and power matter less than capital
...
### S12.14 Tropical cooling (indicative estimate)
...
### S12.15 Cost stack A: fungal biomass protein for feed
...
| Cooling electricity (0.1 to 1.5 kWh/kg) | 7 | 117 | S12.14: from a thermotolerant or cooling-water case to full chilled water | our estimate |
...
| Labour (60 to 100 FTE) | 44 | 124 | USD 7,400 to 12,350 per FTE a year (S12.4; above the NSO average) [@COST-19; @COST-20] | assumption on measured wages |
...
**Not included, and pushing the high case up.** Because feed is not subject to VAT, input VAT on capex and taxed inputs is not reclaimable, adding about 5 to 10% on those inputs (S12.6). The feed-ingredient listing process also takes time (6 to 18 months by our estimate; [[app-s6-feed-market]]).

### S12.16 Cost stack B: textured soy protein (TVP)

Dry TVP from food-grade, low-temperature defatted soy flour by low-moisture extrusion on a Chinese-equipped line; two line sizes (0.5 and 1 t/h) at 50, 70 and 90% utilisation of 8,000 hours a year; USD per tonne of product; 2026 prices; including delivery to the buyer, a capital charge and working-capital interest; excluding VAT, sales and profit. Protein taken as 52%. Indicative. Rebuilt from the textured-protein investor card (W7-L5); the full rows are in `t1_cost_per_kg.csv`. Label for the result: {VN-direct|Low}.

**Inputs.**

| Line | Value used | Basis | Type |
|---|---|---|---|
| Food-grade defatted soy flour, delivered | USD 627 to 925 per t; 1.03 to 1.07 t per t of product (USD 646 to 990 per t of product) | Low: China's soybean-meal exports to Vietnam at USD 604 per t FOB in 2025 (28,158 t, grade unknown) plus 3% freight. High: Indian and Dutch soy flour at USD 783 to 896 per t FOB (2024 and 2025), USD 850 used, plus 5% freight, 2% MFN duty and USD 15 per t local [@TIC-12; @TIC-13; @REG2-21] | measured trade prices; grade assumed |
| Electricity | 150 to 350 kWh per t at 1,952 VND per kWh (22 kV, 24-hour blend) | Supply-chapter range, supported by the power ratings in the listings (80 to 311 kWh per t) [@COST-01; @TIC-02; @TIC-10] | measured price; assumed use |
| Dryer heat; water and wastewater; B2B bags; outbound delivery | 0.4 to 0.8 t of steam per t; USD 2 to 7; USD 10 to 20; USD 10 to 30 per t | As stack A; assumptions [@COST-16; @COST-17] | measured price; assumed use |
| Labour | 18 to 28 FTE (0.5 t/h) or 22 to 34 FTE (1 t/h) at USD 5,560 to 12,350 per FTE a year | Low: average income of 9.0 million VND a month, 13 months, 23.5% on-costs; high: 20 million VND [@COST-19; @COST-20] | assumption on measured wages |
| Rent | 1,500 to 2,000 m2 (0.5 t/h) or 2,000 to 3,000 m2 (1 t/h) at USD 4.9 to 5.1 per m2 a month | Ready-built factory, Q2 2026 [@COST-21; @COST-22] | measured price; assumed area |
| Installed capex | USD 0.28 to 1.0 M (0.5 t/h); USD 0.32 to 1.38 M (1 t/h) | Listed Chinese line with dryer at USD 30,000 to 300,000 (up to three times list), plus freight, installation, utilities, bagging and QA, food-grade fit-out, certification and a 15% contingency (our calculation) [@TIC-02; @TIC-03; @TIC-07] | listings plus assumptions |
| Capital charge; maintenance | 12 to 18% of installed capex; 4 to 6% a year | Supply-chapter range; assumption | assumption |
| QA, certification, insurance, administration | USD 60,000 to 150,000 a year | Assumption | assumption |
| Working capital and interest | 3 to 4 months of revenue at parity (USD 0.72 to 1.73 M at 0.5 t/h; 1.44 to 3.46 M at 1 t/h); 8 to 10% a year | Assumption: 1.5 months of imported flour, 1 month of stock for lunar peaks, 1.5 months of receivables | assumption |

**Results.**

| Line size | Utilisation | Output, t a year | Full cost, low case, USD per t | Full cost, high case, USD per t | Raw material share | Capital charge, USD per t | VND per 100 g of protein |
|---|---|---|---|---|---|---|---|
| 0.5 t/h | 50% | 2,000 | 858 | 1,573 | 75% to 63% | 17 to 91 | 4,290 to 7,860 |
| 0.5 t/h | 70% | 2,800 | 816 | 1,450 | 79% to 68% | 12 to 65 | 4,080 to 7,250 |
| 0.5 t/h | 90% | 3,600 | 793 | 1,382 | 81% to 72% | 9 to 50 | 3,970 to 6,910 |
| 1 t/h | 50% | 4,000 | 800 | 1,414 | 81% to 70% | 9 to 62 | 4,000 to 7,070 |
| 1 t/h | 70% | 5,600 | 774 | 1,337 | 83% to 74% | 7 to 44 | 3,870 to 6,680 |
| 1 t/h | 90% | 7,200 | 761 | 1,294 | 85% to 77% | 5 to 34 | 3,800 to 6,470 |

Our calculation [@TIC-12; @TIC-13; @COST-01; @COST-19; @COST-20; @COST-21] {VN-direct\|Low}. The low case pairs all low inputs and the high case all high inputs. With a European-grade line (unverified; USD 2.0 to 5.6 M installed on the earlier equipment assumption of USD 1.5 to 4.0 M), the capital charge would be USD 33 to 181 per t.

**Reading.**

- **Flour is the cost.** Raw material is 63 to 85% of full cost. The two cases differ by USD 344 per t on flour alone; all other costs together run USD 115 to 304 per t at 1 t/h and 90%, and up to USD 583 at 0.5 t/h and 50%. Scale and utilisation matter only in the high-cost case (our calculation).
- **Equipment is not the barrier.** With Chinese equipment the capital charge is USD 5 to 91 per t, 1 to 6% of full cost. Working capital, USD 0.6 to 3.5 M, is the larger funding need {VN-direct|Low}.
- **The competitor lands inside the domestic range.** In 2025 China shipped HS 2106.10 to Vietnam at USD 1.24 per kg FOB (10,201 t), its lowest price to any of eight Asian and US partners (world average USD 1.95) [@TIC-12; @TIC-14] {VN-direct|Medium}. Landed at the 0% ACFTA or RCEP duty it actually pays, it costs about USD 1.29 to 1.38 per kg (USD 1.35 to 1.44 if the 5% MFN duty applied) [@TIC-12; @BUY-02; @FTR-32] {VN-direct|Medium}. India shipped 2,372 t at USD 0.98 per kg, which lands at about USD 1.08 to 1.15 [@BUY-02] {VN-direct|Medium}. The domestic full cost is USD 0.76 to 1.57 per kg, so the delivered flour price decides the margin (our calculation; `t1_landed_competitor.csv`).
- **Margin and breakeven.** At Chinese parity with 0% duty, the low case earns 33 to 41% and pays back in about a year; the high case runs from a 22% loss to breakeven. To earn 15% on a 1 t/h line at 70% utilisation, delivered flour must cost less than about USD 700 to 940 per t (our calculation; `t1_margin_payback.csv`) {VN-direct|Low}. Chinese lines are on sale in Ho Chi Minh City, yet no one has built one, which suggests the low flour price is not available for food-grade, low-temperature, often non-GMO flour (our inference). A written quote for delivered flour is the decisive number.
- **No input advantage.** Vietnam crushes about 2.6 Mt of soybeans a year for feed meal and has no food-grade defatted flake stream [@FORM-10] {VN-direct|Medium}; it grows only about 1.6% of its soybean supply (42 kt against 2.61 Mt imported in 2025; our calculation from [@MAC-04; @MAC-09]). A Vietnamese line buys most of its cost from the countries whose product it replaces, and its net shelter from freight and duty is only about USD 30 to 130 per t (our calculation).
- **Manufacturing cost is not what blocks plant-based foods.** The ex-factory cost of 3,800 to 7,900 VND per 100 g of protein is about 4 to 18 times below retail meat and egg protein (34,300 to 69,500 VND per 100 g; S12.10). Retail dried soy analogues sell at about 51,000 VND per 100 g of protein (one product) and a median of 64,584 across four products [@COST-42; @FORM-01], about 6 to 17 times the ex-factory cost (our calculation). The gap is distribution, brand and retail margin, and product quality.
- **A different, dearer product.** The earlier stack (3,000 t a year on one 1 t/h line, USD 792 to 2,065 per t) assumed European-scale equipment and, in its high case, a 50:50 blend of soy flour and soy protein concentrate at USD 1,300 per t. A concentrate-based texturate is a separate, dearer product; this stack covers plain flour-based TVP.
...
2. **Capex is the swing factor for fermentation** and is the least Vietnamese of the inputs. No Vietnamese fermentation or extrusion capex was found; equipment majors' Vietnamese presence was not verified ([[app-s5-facilities]]). For textured soy the swing factor is the delivered flour price, not capex; the Chinese equipment prices are list prices, not quotes.
...
6. **Tax treatment is unresolved.** Whether a new feed ingredient counts as "animal feed" for VAT, and whether a fermentation plant qualifies for high-technology CIT incentives, are open questions ([[app-s9-regulation]]).
...
| 8 | Partly closed for dry TVP (Chinese listings, S12.11 and S12.16). Still open: firm quotes, a European-grade TVP line and plant protein isolate capex | Capital line of stack B; isolate plants | Requests for quotation to three Shandong makers and one European maker; the freeze-alignment TEA full text |
| 9 | Official grid emission factors for 2024 and 2025 | Scope 2 claims | MAE Department of Climate Change |
| 10 | Whether the 8% VAT cut is extended beyond 31 December 2026 (its end date is now confirmed); whether SCP counts as feed for VAT | Input-VAT cost of feed-protein plants; 2027 VAT on processed foods | General Department of Taxation; National Assembly session records |
...
| 15 | Delivered price of food-grade, low-temperature defatted soy flour (GMO and non-GMO) | Decides the sign of the textured-soy margin (S12.16) | Five written quotes CIF Cat Lai through a partner buyer, with three quotes for Chinese plain TVP |

See [[app-r1-open-questions]] for the full register and [[app-r2-disagreements]] for the conflicts on the blended power price, urea series, fishmeal price, minimum wage, capex per m3 and cooling.
...
- `tariffs.csv`: import duties on feed and food protein inputs, with ATIGA and ACFTA rates; `protein_tariffs_preferential.csv` holds the fuller preferential schedule and VAT notes.
- `t1_cost_per_kg.csv`, `t1_equipment_listings.csv`, `t1_landed_competitor.csv` and `t1_margin_payback.csv`: the textured-soy cost stack, the Chinese equipment listings, the landed price of competing imports, and margins and payback at parity (S12.16).
