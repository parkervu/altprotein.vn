---
id: app-m2-futures-method
title: "M2. Futures method: how the 2050 chapters were built"
...
## M2.1 Purpose and scope of the futures round

Version 0.1 (September 2026) describes Vietnam's alternative-protein supply today and its outlook to 2035 ([[ch19-outlook-2035]]). The futures round asked what could change between 2030 and 2050, and what actors should do now while the answer is uncertain. The research ran on 24 September 2026. The project owner took five decisions before it started.

| Decision | What was decided | Consequence in Part IV |
|---|---|---|
| Packaging | New futures chapters in the same package; executive summaries and briefs updated | Chapters 20 to 24 and 28, Appendices M2 and F2 to F6, 33 data files from the streams and 6 synthesis files |
| Stance | Evidence-anchored foresight plus one bold normative vision, clearly labelled | Horizon scan, exploratory scenarios and signposts; one "Vietnam 2050" vision with backcast milestones ([[ch24-vision-2050]]) |
| Topics | All four: frontier technology; drivers and shocks; economy and policy futures; quantitative projections | Chapters 20 to 22, and a transparent protein and feed balance model for 2030 to 2050 ([[app-f4-balance-model]]) |
...
### M2.2.2 The question tree, Q1 to Q10

| Question | What it asks | Chapter | Detail in | Streams |
|---|---|---|---|---|
| Q1. Drivers to 2050 | Which forces reshape protein supply; which are near-certain, which are critical uncertainties | [[ch20-drivers-2050]] | [[app-f2-drivers-signals]], [[app-f5-targets-hubs]] | GEO, CLM, HSC, AQF |
| Q2. Frontier technology | Readiness, cost and scale paths to 2050; when Vietnam becomes a sensible place for each route | [[ch21-frontier-technology]] | [[app-f3-frontier-tech]] | FTG, FTB, ECF |
| Q3. Inputs that change | Clean power, hydrogen, CO2, carbohydrate, water, land, carbon prices | [[ch21-frontier-technology]] | [[app-f3-frontier-tech]], [[app-f6-aquafeed-feedstock-futures]], [[app-f5-targets-hubs]] | FTG, CLM, NGF, HUB |
| Q4. Protein and feed balance | Feed and feed-protein import need in 2030, 2040 and 2050; what alternative protein could supply | [[ch22-protein-balance-2050]] | [[app-f4-balance-model]], [[app-f6-aquafeed-feedstock-futures]] | QNT, AQF, NGF |
| Q5. Economy and policy futures | Learning curves, capital, carbon pricing, bioeconomy strategies, jobs | [[ch21-frontier-technology]], [[ch20-drivers-2050]] | [[app-f3-frontier-tech]], [[app-f5-targets-hubs]] | ECF, GEO, NTS |
| Q6. Regional race | Where competitors aim to be, and where Vietnam could specialise | [[ch21-frontier-technology]], [[ch23-scenarios-2050]] | [[app-f3-frontier-tech]], [[app-f5-targets-hubs]] | ECF, HSC, HUB |
...
### M2.3.1 Waves and streams

As in v0.1, parallel research streams each had a written brief, a shared protocol and a source-ID prefix. An actor review after wave 3 set two gap waves.
...
|---|---|---|---|---|---|
| FTG | Frontier gas | Gas and electro-fermentation, power-to-protein; resource use and costs; Vietnam's power, hydrogen and CO2 to 2050 | Q2, Q3 | 14 (15) | 35 |
| FTB | Frontier bio | AI design, biofoundries, precision fermentation, cultivated meat and seafood, molecular farming, cell-free, biomass fermentation; approvals | Q2, Q7 | 15 (15) | 51 |
| CLM | Climate | Climate projections, subsidence, salinity, heat; effects on aquaculture, livestock, crops and imported inputs; emission caps | Q1, Q3 | 11 (14) | 43 |
| QNT | Balance model | Published projections to 2035; the 2025 to 2050 balance model in four scenarios; sensitivity | Q4 | 5 (12) | 16 |
| GEO | Geo-macro | Trade and geopolitics, China's feed strategy, animal disease, energy, demography, farm workforce | Q1, Q5 | 15 (15) | 48 |
| ECF | Economy and policy | Learning curves, capital, carbon prices and carbon cost per protein, bioeconomy strategies, jobs | Q5, Q6 | 15 (15) | 46 |
| HSC | Horizon scan | OpenAlex bibliometrics, patents, company, plant and policy signals, wildcards, external forecasts | Q7, Q8 | 14 (15) | 37 |
| NTS | National targets | Every official Vietnamese target for 2030 to 2050 bearing on protein supply, read in the legal texts | Q5, Q9 | 3 (12) | 38 |
| NGF | Next-generation feedstocks | Cellulosic sugar, one-carbon feedstocks, waste streams, released rice land | Q3, Q4 | 11 (12) | 40 |
| AQF | Aquaculture futures | Aquaculture by species, trash-fish replacement, fishmeal, fish oil and omega-3, protein crops | Q1, Q4 | 10 (12) | 36 |
| HUB | Spatial hubs | Energy, hydrogen, CO2, bio-zone, carbohydrate, residue, buyer and research layers by province; six candidate hubs | Q3, Q6, Q9 | 12 (12) | 29 |
| VIS | Vision benchmarks | Protein strategies elsewhere, food-system foresight practice, credible ambitious ranges | Q9, Q10 | 12 (12) | 50 |
| Total | | | | 137 (161) | 469 |

Source counts are rows per prefix in `sources.csv`, which now has 1,275 rows (806 from v0.1). Three rows record our own calculations (QNT-model, NGF-calc, AQF-calc); the text calls these "our calculation" and does not cite them as sources. Each stream's data files are listed in its appendix and in `data/data-dictionary.md`. From the stream results the lead author built six synthesis files: `scenarios_2050.csv`, `signposts_2050.csv`, `play_robustness.csv`, `robust_moves.csv`, `vision_milestones.csv` and `frontier_windows.csv`.
...
## M2.4 Evidence rules and foresight labels

### M2.4.1 Evidence labels and confidence (as v0.1)
...
Our own long-range numbers are Low unless their inputs are strong, which is why most Part IV estimates carry `{VN-direct|Low}`. Disagreeing numbers are never averaged: we give both and the position taken ([[app-r2-disagreements]]).

### M2.4.2 Six foresight types

Every forward-looking statement carries a second badge after the evidence badge, for example `{VN-direct|Low} {fx:estimate}`.

| Type | Token | Definition | The sentence must state | Example from Part IV |
|---|---|---|---|---|
...
### M2.4.4 Targets, projections and estimates kept apart
...
| Our estimate | `fx:estimate` plus "(our calculation)"; inputs in an appendix | Livestock and poultry feed of 26.4 Mt in 2030 (our calculation, [[app-f4-balance-model]]) {VN-direct\|Low} {fx:estimate} |
| Our scenario | `fx:estimate`; "Scenarios, not forecasts" callout | The four worlds of [[ch23-scenarios-2050]] |
| Our vision | Vision badge; "Vision, not forecast" callout | [[ch24-vision-2050]] only |
...
2. **Separate trends from uncertainties.** A driver is a near-certain trend when the people, rules or physics are already in place (cohorts born, caps in law, subsidence measured): section 20.1. The rest are critical uncertainties: section 20.2.
...
| Clean-power delivery | High for protein from power; low before 2040 | High | Partly | No: delivering the power plan is Vietnam's own task | Condition for the chapter 21 windows |
...
Each world in `scenarios_2050.csv` was built in the same steps: fix the axis ends; write a short, internally consistent picture of 2050; map it to the balance-model scenarios of [[ch22-protein-balance-2050]]; state where Vietnam competes and loses; name the active hubs from `candidate_hubs.csv`; link it to a 2035 state of [[ch19-outlook-2035]]; attach signposts and the domestic choice that decides Vietnam's place inside it. The soybean-meal ranges are mappings, not new model runs; a combined S-EFF plus S-ALT case was not modelled.
...
A signpost is an observable event with a threshold that shows which way an axis is moving. We kept one only if it is published at least yearly, has a numeric or event threshold, names where to watch, has a stated September 2026 status and favours identifiable worlds. Sixteen passed (`signposts_2050.csv`; full table in [[app-f2-drivers-signals]]).
...
- **World-jumpers**: six would move Vietnam between worlds within a year, such as an anchoveta collapse (towards C or D) or Chinese export dumping of microbial protein (towards B or D); see section 23.4.
...
Each score is our judgement from chapters 20 to 22 {VN-direct|Low} {fx:estimate}. Reasons are in the `why` column of `play_robustness.csv` and the `evidence_basis` column of `robust_moves.csv`.
...
## M2.7 Vision and backcasting method
...
**The balance model** is `tools/balance_model.py`. It reads `balance_assumptions.csv` (238 rows) and writes `balance_outputs.csv` (1,150 rows) and `balance_sensitivity.csv` (13 rows) for 2025 (base), 2030, 2035, 2040 and 2050 in four scenarios (S-BASE, S-HIGH, S-EFF, S-ALT). It is checked against 86 published projections in `balance_published_projections.csv`. Method, assumptions, checks and sensitivity: [[app-f4-balance-model]].
...
|---|---|---|
| `balance_model/model.py` | Research copy of the balance model; the package copy differs only in paths and record IDs | Chapter 22 |
| `frontier_gas/ftg_estimates.py` | Power, solar and wind capacity, hydrogen and CO2 for 100 kt, 500 kt and 1 Mt of hydrogen-route protein; indicative Vietnamese cost; breakeven hydrogen price | Chapter 21 |
| `econ_policy/ecf_calc.py` | Learning applied to the v0.1 fungal feed-protein cost stack (2030, 2040, 2050); carbon cost per t of protein at USD 25, 50 and 100 per t CO2e; footprint of glucose-based fungal protein | Chapter 21 |
| `geo_macro/build_csvs.py` | Builds `macro_drivers_2050.csv` and `shock_register.csv` from sourced values (population, age, urban share) | Chapter 20 |
| `next_gen_feedstocks/ngf_calc.py` | Sugar-equivalent volumes of residue, one-carbon and waste streams; three what-if cases for 2040 and 2050 against the S-ALT glucose need | Chapter 21 |
| `aquaculture_futures/aqf_calc.py` | Aquaculture by species, aquafeed, crude protein and EPA plus DHA need to 2050; trash-fish replacement; pangasius by-products; credible alternative shares | Chapter 22 |
| `spatial_hubs/hub_calc.py` | Buyer shares by province; straw power potential; hydrogen, CO2 and cassava needs of single plants; S-ALT plant counts by hub | Chapter 24 |
| `vision_benchmarks/vis_calc.py` | Analogue rates of change; model outputs as shares; peer budgets annualised | Chapter 24 |
...
| 2. Wave 3 | Eight streams answered Q1 to Q10 at first pass | 314 sources; 92 searches |
...
| 6. Synthesis | Chapters 20 to 24 and 28 and six synthesis files written from the notes | Consistency decisions below |
| 7. Validation | `tools/validate.py` run on every page | Citations, tags, links, embeds and tables checked by script |
| 8. Independent verification | A separate pass re-traced Part IV headline numbers to notes, data files and scripts, as for v0.1 ([[app-m1-method]]) | Numbers checked before publication |
...
| Extraction tools sometimes paraphrase | A summarising reader can reword a quote or number | Verbatim requests; Vietnamese legal quotes rated Medium unless the same wording appeared in two reads or in v0.1 |
...
**Related:** [[app-m1-method]], [[ch20-drivers-2050]], [[ch23-scenarios-2050]], [[ch24-vision-2050]], [[ch28-robust-moves]], [[app-f4-balance-model]], [[app-f2-drivers-signals]], [[app-r1-open-questions]], [[app-r4-sources]]
