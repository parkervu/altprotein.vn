---
id: app-l-labs-talent
title: "L. Pilot facilities, laboratories and talent"
short_title: "L. Labs and talent"
section: appendix
order: 12
...
related_pages: [ch06-knowledge-talent, ch05-rules, app-f-facilities, app-g-regulation, app-h-feed-market, app-k-research, app-i-costs, brief-startups]
charts: []
---

# L. Pilot facilities, laboratories and talent
...
| Amino-acid profile | Ask NACEFA, NIFC, Eurofins, CASE | Send abroad (Eurofins group laboratories) | Not confirmed on any page read [@INF-03; @INF-11] {VN-direct\|Medium} | Whether amino acids (including tryptophan and sulfur amino acids) are in the VILAS scope |
...
## L.3 Pilot and scale-up facilities
...
## L.4 Testing laboratories and accreditation
...
## L.5 State feed and aquafeed trial centres after the 2025 to 2026 reorganisation
...
That is about 40 working days of agency time (our calculation: 15 + 5 + 15 + 5), plus the trial itself, whose length the circular leaves to the approved protocol [@REG-34] {VN-direct|High}. A total of 6 to 18 months from protocol to listing is the report's estimate, not a published figure; it depends mostly on trial length and on queues at the trial centres. The inputs are discussed in [[app-g-regulation]] {VN-direct|Low}.
...
### Where trials are run

| Facility | Owner | Location | Role | Legal basis and date | Sources |
|---|---|---|---|---|---|
| Central Livestock and Veterinary Trial and Testing Centre I | DLPAH, MAE | Hanoi | Livestock feed trials and testing, method development, reference standards, conformity assessment and certification; may sell services "consistent with its capacity". Created by merging the Central Livestock Trial, Testing and Inspection Centre I with the Central Veterinary Drug Testing Centre I | Decision 3064/QĐ-BNNMT, 4 August 2026; effective 1 October 2026 | [@INF-18] {VN-direct\|High} |
| Central Livestock and Veterinary Trial and Testing Centre II | DLPAH, MAE | Not read (probably Ho Chi Minh City) | Parallel southern centre; functions assumed similar | Decision 3065/QĐ-BNNMT, 4 August 2026 (title only) | [@INF-17] {VN-direct\|Low} |
...
## L.6 Hi-tech parks and hi-tech agriculture zones

**National hi-tech parks**

| Park | Location (current; former) | Size and status | Relevance | Sources |
|---|---|---|---|---|
| Saigon Hi-Tech Park (SHTP) | Ho Chi Minh City, Tang Nhon Phu ward and neighbours (former Thu Duc City) | 913 ha (phase 1: 300 ha; phase 2: 613 ha); 165 projects; USD 14.08 billion registered | Biotechnology for agriculture, health and environment encouraged; hosts SHTP-IC incubator, SHTP Labs, a training centre and a Biotech Center | [@INF-06; @IND-57; @IND-58] {VN-direct\|High} |
| Hoa Lac Hi-Tech Park | Hanoi (former Thach That and Quoc Oai area) | Listed zones sum to 941.79 ha without the education zone: R&D 263.15 ha, high-tech industry 391.01 ha, software 55.93 ha, mixed 80.14 ha, central 43.14 ha, housing 75.50 ha, recreation 32.92 ha | No biotech or food tenant named on the pages read; now managed by a Hanoi board | [@INF-08; @INF-25] {VN-direct\|Medium} |
| Da Nang Hi-Tech Park | Da Nang | Not verified (site failed DNS) | Placeholder only | [@INF-29] {VN-direct\|Low} |

The commonly cited total area of Hoa Lac (about 1,586 ha) could not be verified; we report the zone figures. The managing board's office is in Ha Dong ward under a Hanoi board for hi-tech and industrial parks, which suggests management moved from MOST to Hanoi; the transfer date was not verified [@INF-25] {VN-direct|Medium}. Both points are logged in [[app-r-disagreements]].

**Hi-tech agriculture zones (Decree 263/2026)**

Decree 263/2026/NĐ-CP, effective 1 July 2026, implements the Law on High Technology 2025 (133/2025/QH15) and lets provincial People's Committees set up hi-tech agriculture zones. Incentives include priority for state R&D funds and up to 70% interest subsidy on loans to commercialise technology [@INF-23] {VN-direct|Medium}. This was read through a secondary summary of the decree; article numbers should be checked. Whether alternative-protein or biotech food processing counts as a hi-tech agricultural activity was not established.
...
| North-Central hi-tech forestry zone | Probably Nghe An | Decisions 509/QĐ-TTg (2021) and 746/QĐ-TTg (2025) | Forestry; relevant only for mushroom or mycelium on wood side streams | [@INF-22] {VN-direct\|Low} |

Hanoi has a hi-tech agriculture plan to 2030 (Plan 73/KH-UBND, 12 March 2025; not read) [@INF-22] {VN-direct|Low}. The Ho Chi Minh City hi-tech agriculture park (Cu Chi) was not reached.

## L.7 Talent pipeline and gaps

**Admission quotas (*chỉ tiêu tuyển sinh*), 2026**
...
> **Correction.** Earlier drafts gave the Region I minimum wage as VND 4.96 million a month. The 2026 figure under Decree 293/2025 is VND 5,310,000 a month [@COST-19] {VN-direct|High}. See [[app-i-costs]].

**Diaspora.** Vietnamese researchers abroad in alternative protein were not mapped: Scite returns only the first three authors and no affiliations [@RD-01] {VN-direct|High}.

## L.8 Engineering and equipment suppliers
...
|---|---|
| Pilot fermenter, extruder and dryer inventory | Send a one-page questionnaire to FIRI FTET (production@firi.vn), the Ho Chi Minh City Biotechnology Center (ttcnsh.shtp@tphcm.gov.vn) and SHTP Labs (ttrd.shtp@tphcm.gov.vn). |
...
See also [[app-q-open-questions]].

## Related data files

- `pilot_labs.csv`: 32 pilot plants, testing laboratories, feed-trial centres, hi-tech parks and university facilities, with capabilities, accreditation, access model and contacts.
- `talent.csv`: 11 rows of 2026 admission quotas.
- `engineering_suppliers.csv`: 9 equipment vendors and engineering firms.
- `facilities.csv`: industrial plants that could host or toll a line ([[app-f-facilities]]).
- `institutions.csv`: research institutions and their capabilities ([[app-k-research]]).
- `instruments.csv`: the feed-trial and penalty instruments cited above ([[app-g-regulation]]).
- Working papers: `working-papers/wave2/infra/` and `working-papers/wave1/industry/`.
