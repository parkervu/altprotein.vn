---
id: app-f1-outlook
title: "F1. Milestones and outlook data"
...
### F1.1.4 2030 to 2035 and beyond
...
From `outlook.csv`, UN World Population Prospects 2024 (medium variant), read through Our World in Data [@GT-12] {VN-direct|Medium}.

| ID | Year | Population (million) | Type |
|---|---|---|---|
| OUT-001 | 2025 | 101.6 | Projected |
| OUT-002 | 2030 | 104.25 | Projected |
| OUT-003 | 2035 | 106.53 | Projected |
| OUT-004 | 2040 | 108.44 | Projected |
| OUT-006 | 2049 (peak) | 110.02 | Projected |
| OUT-005 | 2050 | 110.01 | Projected |

- Headcount rises only about 4.9% from 2025 to 2035 (our arithmetic). Demand growth to 2035 will come mainly from income and diet change, not from more people [@GT-12] {VN-direct|Medium}.
- The official statistics office estimate for 2025 is 102.3 million, about 0.7 million above the UN figure [@MAC-19; @GT-12] {VN-direct|High}. We use the official figure for 2025 facts and the UN series for projections, and never mix the two in a growth rate (DG-125).
- A secondary source says Vietnam becomes an "aged society" by 2035, with a total fertility rate of 1.91 in 2024 [@GT-13] {VN-direct|Low}.
...
- 58 to 62 kg of meat per person;
- industrial feed output of 30 to 32 Mt, from 40 to 45 Mt of mill design capacity.
...
| Base | Base volume | Required growth to 30 Mt | Required growth to 32 Mt | Extra feed a year by 2030 |
|---|---|---|---|---|
| 2024 (livestock and poultry) | 21.5 Mt | 5.7% a year | 6.9% a year | 8.5 to 10.5 Mt more than in 2024 |
| 2025 (livestock and poultry) | about 22 Mt | 6.4% a year | 7.8% a year | 8 to 10 Mt more than in 2025 |

Formula: (target / base)^(1 / years) minus 1, with 6 years from 2024 and 5 years from 2025. Inputs: [@MAC-28; @MAC-01; @REG-54] {VN-direct|Medium}.
...
Decision 768/QĐ-TTg of 15 April 2025 [@GT-11] {VN-direct|High}:

| ID | Indicator | Value | Year |
|---|---|---|---|
| OUT-066 | Non-hydro renewable share of electricity generation | 28 to 36% | 2030 |
| OUT-067 | Renewable share of electricity (orientation) | 74 to 75% | 2050 |
| OUT-068 | Commercial electricity | 500.4 to 557.8 TWh (1,237.7 to 1,375.1 TWh in 2050) | 2030 |
| OUT-069 | Solar capacity, including rooftop | 46.5 to 73.4 GW; onshore wind 26.1 to 38.0 GW; offshore wind 6.0 to 17.0 GW; biomass 1.5 to 2.7 GW; waste-to-energy 1.4 to 2.1 GW; coal 31.1 GW; LNG 22.5 GW | 2030 |
| OUT-070 | Nuclear capacity (former Ninh Thuan sites, now in Khanh Hoa) | 4.0 to 6.4 GW | 2030 to 2035 |
| OUT-071 | Power sector greenhouse gas emissions | 197 to 199 Mt CO2e (about 27 Mt by 2050) | 2030 |
| OUT-072 | GDP growth assumed in the plan | 10.0% a year (2026 to 2030); 7.5% a year (2031 to 2050) | 2026 to 2050 |
| OUT-073 | Investment need for sources and transmission | USD 136.3 billion | 2026 to 2030 |
...
### F1.5.1 Annual actuals and forecasts (World Bank Commodity Markets Outlook, April 2026)

All nominal US dollars. Forecasts end at 2027 [@GT-14] {general|High}.

| Commodity | Unit | 2024 actual | 2025 actual | 2026 forecast | 2027 forecast | Latest monthly |
|---|---|---|---|---|---|---|
| Maize | USD/t | 191 | 203 | 211 | 214 | 224 (Aug 2026) |
| Soybean meal | USD/t | 442 | 366 | 359 | 363 | 403 (Aug 2026) |
| Soybeans | USD/t | 462 | 414 | 441 | 446 | n/a |
| Soybean oil | USD/t | 1,022 | 1,140 | 1,233 | 1,236 | n/a |
| Rice, Thai 5% | USD/t | 588 | 408 | 401 | 413 | n/a |
| Palm oil | USD/t | 963 | 1,007 | 1,089 | 1,096 | n/a |
| Crude oil, Brent | USD/bbl | 80.7 | 69.0 | 86.0 | 70.0 | n/a |
| Urea, Eastern Europe | USD/t | 338 | 423 | 675 | 500 | n/a |
| Sugar, world | USD/kg | 0.45 | 0.37 | 0.35 | 0.34 | n/a |
| Fishmeal | USD/t | 1,699 | 1,706 | no forecast | no forecast | 2,500 (Aug 2026) |
...
| 2025 | 1,706 | 366 | 4.7 | [@GT-15] {general\|High} |
| Q1 2026 | 1,832 | 393 | 4.7 (our calculation) | [@GT-15] {general\|High} |
| Q2 2026 | 2,045 | 419 | 4.9 (our calculation) | [@GT-15] {general\|High} |
| Jun 2026 | 2,145 | not extracted | n/a | [@GT-15] {general\|High} |
| Jul 2026 | 2,103 | not extracted | n/a | [@GT-15] {general\|High} |
...
|---|---|---|---|---|---|---|---|
| 1 | Fishmeal price, World Bank series | USD 2,500/t (Aug 2026); 2025 average USD 1,706/t | World Bank Pink Sheet | Monthly | Above USD 2,000/t on average in 2027 | Scenario 2 | [@GT-15] {general\|High} |
| 2 | Fishmeal price, World Bank series | as above | World Bank Pink Sheet | Monthly | Below USD 1,800/t for 12 months in a row | Scenario 1 | [@GT-15] {general\|High} |
| 3 | Fishmeal to soybean meal price ratio | 6.2 (Aug 2026); 3.8 (2024) | World Bank Pink Sheet (our calculation) | Monthly | Sustained above about 5 supports fishmeal replacers; back below 4 weakens them (our judgement) | Scenario 2 vs 1 | [@GT-15] {general\|High} |
| 4 | "New food" definition and procedure in the Food Safety Law or its decree | None in public summaries of the July 2026 draft | National Assembly session outcome; the implementing decree | At each session; at decree publication | Present with a workable procedure | Scenario 3 (absent by end-2027: Scenario 1) | [@REG2-05; @REG2-06] {VN-direct\|Medium} |
| 5 | Food sandbox approvals | None found; Hanoi lists biotechnology as a priority field | Hanoi People's Committee decisions; any decree under Law 93/2025 Art 21(6) | Quarterly | First approval of a food product | Scenario 3 | [@REG2-17; @REG2-14] {VN-direct\|Medium} |
| 6 | Livestock and aquafeed permitted lists | Livestock list unchanged since Feb 2023; aquafeed list has no raw-material section | MAE circulars amending Circular 21/2019 Appendix VI and Circular 16/2026 Appendix II | At each annual update | SCP, fungal biomass or new microbial protein named | Scenario 2 | [@REG2-08; @REG2-09; @REG2-01] {VN-direct\|High} |
...
|---|---|---|
| 1 | Scope of the Decision 1520 feed target (livestock only, or all industrial feed including aquafeed) | Read the decision text on the feed-industry target; ask the MAE Department of Livestock Production and Animal Health |
| 2 | OECD-FAO and USDA long-run projections for Vietnam (meat, feed, aquaculture to 2034 or 2035) | OECD Data Explorer (Agricultural Outlook dataset); USDA ERS international baseline tables |
| 3 | Long-run price paths beyond 2027 | IMF commodity price assumptions or the OECD-FAO baseline |
| 4 | Vietnam NDC 3.0 and any 2035 agriculture or methane target | UNFCCC NDC registry, or the MAE Department of Climate Change |
| 5 | China's 15th Five-Year Plan text on biomanufacturing and food (MS-012 is unverified) | The National People's Congress outline (full text, March 2026) |
| 6 | Food Safety Law vote date | National Assembly agenda for the May 2027 session (first comments October 2026) |
| 7 | Aquafeed volume in 2025 (industry 3.9 to 4.8 Mt vs USDA 6.5 Mt) | One call to the Vietnam Feed Association or a top shrimp feed mill |
| 8 | 2025 feed output from MAE's own year-end report, to test the 2030 target | MAE year-end report |
| 9 | A monthly tracker of fishmeal, soybean meal, maize, cassava chips and HS 2102 and 2309 imports | Build from the World Bank Pink Sheet and customs statistics |

## Related data files

- `milestones.csv`: the 30 dated milestones in section F1.1.
- `outlook.csv`: the 75 outlook rows used in sections F1.2 to F1.6, with type (measured, target, projected, derived) and assumptions.
- `macro_indicators.csv`: feed output, imports and macro context (see [[ch01-why-vietnam]]).
- `feed_benchmarks.csv`: fishmeal and soybean meal prices per tonne of protein (see [[app-s6-feed-market]]).
- `disagreements.csv`: DG-060, DG-084, DG-115, DG-116, DG-120, DG-122 and DG-125 to DG-127 (see [[app-r2-disagreements]]).
