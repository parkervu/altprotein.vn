...
{{chart:chart-technology-fit-matrix}}
...
**The science supports partial, not full, replacement.** In whiteleg shrimp, gas-fermentation protein replaces about 30% of fishmeal without growth loss; halving fishmeal cut growth unless a bile acid was added. Methanotroph meal had lower digestibility in one Chinese screen [@SCI-23; @SCI-24] {general|High}. Black soldier fly meal did no better (growth fell at 30% replacement) [@SCI-27] {general|High}. A 2025 preprint reports mixed-culture protein grown on soybean-processing wastewater replacing up to 90% of fishmeal in shrimp, directly relevant to Vietnam's tofu and soy-milk industry but not yet peer reviewed [@SCI-25] {VN-adjacent|Medium}.
...
- **Duckweed (*bèo*).** Protein is 20 to 30% of dry weight in *Wolffia* grown in the laboratory, up to 44% in Thai *Wolffia* [@SCI-34; @SCI-35] {general|High}. Planning yields are 10 to 30 t of dry matter per hectare per year [@SCI-36; @SCI-37] {general|Medium}. Duckweed is already a permitted livestock feed material [@REG-32; @REG-33] {VN-direct|High}, and Vietnamese researchers hold more than 100 wild samples [@RD-44] {VN-direct|Medium}. For food, manganese is the gate: EFSA could not establish the safety of whole *Wolffia* powder in 2021 because of manganese intake, but judged a *Lemna* protein concentrate safe in 2023 [@SCI-28; @SCI-29; @SCI-30] {general|High}. A "PDCAAS 0.89" figure repeated in earlier drafts has no traceable source [@SCI-34] {general|Low}. Fit: feed on aquaculture effluent now (with heavy-metal testing), food as a protein concentrate later.
- **Microalgae.** Vietnam has small spirulina producers selling supplements, a salt-tolerant spirulina strain reaching 48.7% protein, and a research base at regional level [@ECO-52; @ECO-53; @RD-21] {VN-direct|Medium}. Algae are on the feed list and spirulina is an ordinary food. But production is small and costly, and one source claims most spirulina sold in Vietnam is imported [@ECO-53] {VN-direct|Low}. A niche with incumbents, not a bulk protein route.
