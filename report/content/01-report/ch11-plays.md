...
> **How to use this chapter.** The scores are our judgement, based on the evidence in chapters 2 to 10. They are a starting point for discussion, not an investment rating. The data file `plays.csv` holds every field shown here, and `play_weight_presets.csv` holds the weights, so the website can let readers change them.
...
Source: AltProtein Vietnam scoring ([[ch10-technology-fit]] and the evidence cited in each play) {VN-direct\|Medium}.

{{chart:chart-plays-scoring}}
...
- **Why Vietnam.** Every audited Vietnamese product with 10 g of protein or more per 100 g runs on imported textured soy, soy protein or gluten, mostly Chinese; we found no commercial extrusion in Vietnam; ordinary food rules apply [@FORM-01; @FORM-05; @FORM-11] {VN-direct|Medium}.
...
- **First customers.** An Nhien, Au Lac, Xuan Hong, LC Foods, Cholimex, CJ Foods Vietnam, Vissan, Thoai An, GN Foods and other co-packers [@FORM-01] {VN-direct|Medium}.
- **Partners.** Extrusion-line suppliers; a soy crusher for a food-grade flake stream [@FORM-10]; FIRI for pilot trials.
- **Horizon and capital.** 0 to 2 years; indicative equipment USD 1.5 to 4 million for a 1 t/h line (assumption; see [[ch09-economics]]).
...
- **Must be true.** Repeatable species-specific trials show at least a 3 to 5% gain in survival or feed conversion at 1 to 5% inclusion; a legal route for aquafeed use; cost below the functional willingness to pay (about USD 1,000 to 4,250 per tonne in total for pangasius; USD 1,280 to 4,800 per tonne above fishmeal parity for shrimp; [[ch09-economics]]).
- **Kill tests.** Two independent tank or pond trials show no gain at 5% inclusion or less; Chinese by-product biomass [@FM-12] delivers the same function for less.
- **First customers.** Sheng Long, CP Vietnam, Uni-President Vietnam, Tongwei, Grobest, Gromax; integrated pangasius groups such as Vinh Hoan [@FM-04; @ECO-05] {VN-direct|Medium}.
...
- **Horizon and capital.** 3 to 6 years; tens of USD millions; a candidate for development-finance first-loss capital, as in the Entobel template ([[ch07-capital]]).
...
- **Why Vietnam.** Vietnam shipped 2.15 Mt of cassava starch in 2023, 93.5% to China, while China imported only USD 0.16 million of glucose syrup from Vietnam in 2024 [@RGN-53; @RGN-55] {VN-direct|High}. Starch factories cluster in Tay Ninh and the Central Highlands ([[ch02-asset-map]]).
...
- **First customers.** Domestic fermenters; foreign biomass or precision-fermentation firms looking for a lower-cost ASEAN site ([[ch08-regional]]).
...
- **Why Vietnam.** Aerobic tanks exist inside Vedan, Ajinomoto and Daesang, but we found no published tolling offer and no open pilot fermenter ([[ch03-industrial-base]]) [@INF-02; @INF-05] {VN-direct|Low}.
...
- **Partners.** Saigon Hi-Tech Park [@INF-06], FIRI, the amino-acid producers, and an access arrangement with Thailand's EECi pilot plant [@RGN-36].
...
- **Must be true.** A product that is economic at 1 to 10 g/L; freedom to operate [@SCI-08]; a foreign approval or an ingredient use outside novel-food rules; a clear GMO pathway ([[ch05-rules]]).
...
- **Why Vietnam.** A *tương* tradition; local gene tools for *A. oryzae* [@RD-33; @RD-34] {VN-direct|Medium}; koji on food substrates goes through ordinary self-declaration ([[ch05-rules]]).
- **Must be true.** A characterised strain without cyclopiazonic acid or 3-nitropropionic acid risk [@SCI-19] {general|High}; a food-grade substrate supply; acceptance in *chay* and mainstream dishes.
...
{{chart:chart-plays-horizon}}

## 11.4 Six public goods

These are not businesses. They lower the cost and risk of every play above, and most are cheap. [[ch12-policy-options]] sets out who would do each.
...
| P4 | Protein-quality laboratory (amino acids, DIAAS) | T1, T9, T10, and any novel-food dossier | ([[ch12-policy-options]]) |
| P5 | Yearly by-product atlas (volume, location, price, composition) | T3, T4, T6, T9 | ([[ch12-policy-options]]) |
| P6 | Open cost model and public feed-ingredient price series | All fermentation plays; investor screening | ([[ch12-policy-options]]) |
...
- **Replacing soybean meal in pig and poultry feed with fermentation protein.** The price gap is 4.6 to 5.1 times at the low end of our cost range ([[ch09-economics]]).
- **Premium imported-style consumer analogues as a first business.** They sell at an order of magnitude above chicken and egg protein and appear only in a few premium stores ([[ch04-alt-protein-today]], [[ch09-economics]]).
- **Commodity precision-fermented dairy or egg proteins made in Vietnam.** Titers, rules and missing infrastructure all point the other way ([[ch10-technology-fit]]).
- **Cultivated-meat production.** No cell line, no route, and costs 7 to 15 times retail meat ([[ch10-technology-fit]]).
- **Insect protein.** Out of this report's scope as a play; an established incumbent and benchmark ([[ch04-alt-protein-today]]).
...
**Related:** `plays.csv` (all fields), [[ch12-policy-options]], [[brief-investors]], [[brief-startups]], [[brief-manufacturers]].
